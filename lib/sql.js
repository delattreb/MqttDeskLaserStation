...
sqlconnection.connect(function (err) {
    if (err) {
        logger.error('SQL connection error ' + credential.db.database + ' on port ' + credential.db.port)
        throw err
    } else
        logger.info('SQL connection ' + credential.db.database + ' on port ' + credential.db.port)
})
...
|
/*-----------------------------------------------------------------------------------------------*/
function getAllPlayers(connected) {
